...
<main id="main" class="main">
  ...
  <div class="pagetitle col-lg-8">
    <h1 class="text-center">MODIFICATION D'UNE DEMANDE</h1>
  </div><!-- End Page Title -->
  ...
  <section class="section dashboard">
    ...
    <div class="row">
      <form action="{{route('demande.update', [$demande->id])}}" method="POST" class="form-group">
        @csrf
        
        <div class="mb-3 row">
            <label for="nom" class="col-sm-2 col-form-label">Nom de l'étudiant</label>
            <div class="col-sm-10">
                <select name="nom_etudiant" class="form-select" value="{{ $demande->nom_etudiant }}" required>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select name="periode" class="form-select" value="{{ $demande->periode }}" required>
